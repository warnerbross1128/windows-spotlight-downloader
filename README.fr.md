...
<p align="center">
  <img src="assets/logo.png" width="120" alt="Logo Windows Spotlight Downloader">
</p>
...
- Choisir la langue de l'interface : anglais ou français.
...
2. Dans la dernière release, télécharger [WindowsSpotlightDownloader.exe](https://github.com/warnerbross1128/windows-spotlight-downloader/releases/download/v1.1.0/WindowsSpotlightDownloader.exe).

   ![Bouton WindowsSpotlightDownloader.exe](docs/screenshots/install-download-exe.png)

## Vérifier Le Téléchargement

Le SHA256 de `WindowsSpotlightDownloader.exe` pour la version `1.1.0` est :
...
![Vue Images](docs/screenshots/fr/images.png)

### Configurer La Bibliothèque

![Vue Config](docs/screenshots/fr/config.png)
...
Une fenêtre Windows s'ouvre avec l'interface de l'application. Les fichiers sélectionnés sont enregistrés dans `Images telechargees` par défaut.
...
## Configurer La Bibliothèque Et La Langue

Ouvrir l'onglet `Config`, choisir ou saisir le dossier de bibliothèque, sélectionner la langue, puis cliquer sur `Enregistrer`.
